...
class AnimationHandler {
    ...
    private static class FrameCallbackProvider16 extends AnimationFrameCallbackProvider {
        ...
        FrameCallbackProvider16(AnimationCallbackDispatcher dispatcher) {
            ...
            this.mChoreographerCallback = new Choreographer.FrameCallback() { // from class: smartisanos.widget.dynamicanimation.AnimationHandler.FrameCallbackProvider16.1
        ...
        @Override // smartisanos.widget.dynamicanimation.AnimationHandler.AnimationFrameCallbackProvider
    ...
    private static class FrameCallbackProvider14 extends AnimationFrameCallbackProvider {
        ...
        FrameCallbackProvider14(AnimationCallbackDispatcher dispatcher) {
            ...
            this.mRunnable = new Runnable() { // from class: smartisanos.widget.dynamicanimation.AnimationHandler.FrameCallbackProvider14.1
