...
public class SmartisanTipsBar extends TextView {
  public SmartisanTipsBar(Context context) {
    this(context, null);
  }

  public SmartisanTipsBar(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public SmartisanTipsBar(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr, R.style.SmartisanTipsBarAppearance);
  }
