...
fail_if_match "Removed compatibility shells must not return" \
  '\bSmartisan(AppBarLayout|CollapsingToolbarLayout|FloatingToolbarLayout|ExtendedButton|CardView|EditText|TextInputLayout|Slider|TabLayout|TabLayoutMediator|BottomSheetDialogFragment)\b' \
  core catalog system
